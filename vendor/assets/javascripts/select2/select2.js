...
(function ($, undefined) {
    ...
    $.fn.select2.defaults = {
        ...
        formatInputTooShort: function (input, min) { var n = min - input.length; return "Arama yapmak icin " + n + " karakter girin" + (n == 1? "" : "s"); },
        formatInputTooLong: function (input, max) { var n = input.length - max; return "Arama yapmak icin " + n + " karakter silin" + (n == 1? "" : "s"); },
        formatSelectionTooBig: function (limit) { return "Sadece " + limit + " birim secebilirsiniz" + (limit == 1 ? "" : "s"); },
        formatLoadMore: function (pageNumber) { return "Sonuclar yukleniyor..."; },
        formatSearching: function () { return "Araniyor..."; },
